      ...
      DateTime endTime, int bitrate, string outFile, DialogProgress dialogProgress)
        {
            ...
            ffmpegAudioProgArgs = String.Format("-vn -y -i \"{0}\" {1} {2} {3} -application voip \"{4}\"",//ffmpegAudioProgArgs = String.Format("-vn -y -i \"{0}\" -ac 2 {1} {2} {3}  \"{4}\"",
                                                                                                                                      // Video file
                                                inFile,              // {0}
        ...
        public static void normalizeAudio(string dir)
        {
            ...
            string args = String.Format(@"{0} ""{1}{2}*.opus""",
