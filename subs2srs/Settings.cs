...
namespace subs2srs
{
  public static class PrefDefaults
  {
    ...
    public const bool DefaultAudioNormalize = true;
    ...
    public const string AudioFilenameFormat = "${deck_name}_${0:episode_num}_${0:s_total_hour}.${0:s_min}.${0:s_sec}.${0:s_msec}-${0:e_total_hour}.${0:e_min}.${0:e_sec}.${0:e_msec}.opus";
    public const string SnapshotFilenameFormat = "${deck_name}_${0:episode_num}_${0:m_total_hour}.${0:m_min}.${0:m_sec}.${0:m_msec}.webp";
    ...
    public const string ExtractMediaAudioFilenameFormat = "${deck_name}_${0:episode_num}_${0:s_total_hour}.${0:s_min}.${0:s_sec}.${0:s_msec}-${0:e_total_hour}.${0:e_min}.${0:e_sec}.${0:e_msec}.opus";
  ...
  public static class ConstantSettings
  {
    ...
    private static string helpPage = "https://github.com/abc123sm/subs2srs/";
    ...
    private static string tempAudioFilename = String.Format("~subs2srs_temp_{0}.opus", Guid.NewGuid().ToString());
    ...
    private static string normalizeAudioExe = "rsgain.exe"; // 修改为 rsgain.exe
    private static string pathNormalizeAudioExeRel = String.Format("Utils{0}rsgain{0}{1}", Path.DirectorySeparatorChar, normalizeAudioExe); // 更新路径
    ...
    {
        get { return defaultabc123smaudiocpu; }
        set { defaultabc123smaudiocpu = value; }
    }

    public static int Defaultabc123smsnapcpu
    {
        get { return defaultabc123smsnapcpu; }
        set { defaultabc123smsnapcpu = value; }
    }
    }
  ...
  public class Snapshots
  {
    ...
    {
      enabled = true;
      size = new ImageSize((int)(1920), (int)(1080));
      crop = new ImageCrop(0, 0, 0, 0);
    }
  }
