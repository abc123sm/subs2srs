...
namespace subs2srs
{
  ...
  partial class DialogAbout : Form
  {
    public DialogAbout()
    {
      ...
      this.linkLabelWebsite.Text = "https://github.com/abc123sm/subs2srs/";
    }

    private void linkLabelContact_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
      System.Diagnostics.Process.Start("mailto:subs2srs@qf-channel.eu.org");

    }

    private void linkLabelWebsite_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
      System.Diagnostics.Process.Start("https://github.com/abc123sm/subs2srs/");
    }
